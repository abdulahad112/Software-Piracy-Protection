...
# Save Time Thank you 
    def create_main_menu(self):
        ...
        self.help_pageb = ttk.Button(self.root, text="Bug Report", command=self.bug_page)
        ...
        self.visit_button = ttk.Button(self.root, text="Visit Us", command=self.visit_link)
